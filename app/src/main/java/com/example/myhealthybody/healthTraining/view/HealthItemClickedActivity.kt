...
import com.example.myhealthybody.healthTraining.view.adapter.ItemClickedRecyclerAdapter

class HealthItemClickedActivity : AppCompatActivity() {
    private lateinit var binding: ActivityFragmentOneItemBinding
    private lateinit var instructionRecyclerView: RecyclerView
    private lateinit var instructionRecyclerAdapter: ItemClickedRecyclerAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        instructionRecyclerAdapter = ItemClickedRecyclerAdapter(exerciseInstruction)
