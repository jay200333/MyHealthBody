package com.example.myhealthybody.healthTraining.view
...
import com.example.myhealthybody.databinding.FragmentHealthTrainingBinding
import com.example.myhealthybody.util.RecyclerDecoration
import com.example.myhealthybody.healthTraining.view.adapter.RecyclerAdapter
import com.google.android.material.tabs.TabLayout

class HealthTrainingFragment : Fragment() {
    private lateinit var mBinding: FragmentHealthTrainingBinding
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentHealthTrainingBinding.inflate(inflater, container, false)
    ...
    private fun onExerciseClicked(exercise: ExerciseData) {
        val intent = Intent(requireContext(), HealthItemClickedActivity::class.java)
